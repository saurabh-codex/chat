...
export const Chat = ({ room }) => {
  ...
  return (
    <div className="chat-app min-h-screen max-h-fit">
      <div className="header mt-14">
        <h1 className="titleroom fixed z-50">Room {room.toUpperCase()}</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="new-message-form w-full flex justify-center items-center fixed bottom-0 z-50 py-3">
        <input
          type="text"
          value={newMessage}
